...
function iife() {
    ...
    */
    function calculator(number, otherNumber){
        function otherFunct(callback){
            return callback(number, otherNumber);
        }
        return otherFunct;
    }
    /*
    ...
    */
    let subtraction = calculator(3,2);
    let multiplication = calculator(3,2);
    let division = calculator(4,2);
    let mod = calculator(4,2);
    /*
